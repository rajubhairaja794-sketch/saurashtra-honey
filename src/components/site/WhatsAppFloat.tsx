...
export function WhatsAppFloat() {
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp"
      className="fixed z-50 bottom-[100px] md:bottom-6 right-4 md:right-6 w-[56px] h-[56px] hover:scale-105 transition-transform flex items-center justify-center drop-shadow-lg overflow-hidden">
