...
function FooterSection({ title, children }: { title: string, children: React.ReactNode }) {
  return (
    <div className="flex flex-col space-y-4 lg:space-y-6">
      <h4 className="font-serif text-[12px] font-bold uppercase tracking-[0.2em] text-[#C57A1C]">
        {title}
      </h4>
      {children}
    </div>
      ...
      <div className="relative z-20">
              ...
              <div className="col-span-1">
                <FooterSection title="Shop">
                  <ul className="space-y-4 text-[14px] lg:text-[13px] text-[#2B1D14]/80 font-medium">
                    <li>
                      <Link to="/shop" className="hover:text-[#C57A1C] transition-colors duration-300">All Products</Link>
                    </li>
        ...
        <div className="container-page px-6 lg:px-8 mt-12">
          ...
          <div className="py-10 flex flex-col items-center justify-center text-center gap-3">
            <p className="text-[11.5px] font-bold uppercase tracking-[0.25em] text-[#C57A1C]/90">
