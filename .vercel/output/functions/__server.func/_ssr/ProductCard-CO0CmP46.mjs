...
import { s as useCart, u as useWishlist } from "./collection-helpers-BfZPBpPQ.mjs";
import { _ as useNavigate, g as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { Nt as Eye, S as ShoppingCart, gt as Heart, v as Star, wt as GitCompare } from "../_libs/lucide-react.mjs";
import { n as toItem, r as track } from "./analytics-By36XOiQ.mjs";
import { n as useCompare } from "./compare-Cg9kkhzV.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/ProductCard-CO0CmP46.js
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "absolute top-2.5 right-2.5 md:top-3 md:right-3 z-10 flex flex-col gap-1.5",
				...
				onQuickView && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					className: "hidden md:inline-flex absolute bottom-3 left-1/2 -translate-x-1/2 z-10 items-center gap-1.5 bg-espresso text-cream text-[11px] font-bold tracking-widest px-4 py-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity hover:bg-burnt-orange hover:text-white shadow-md",
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: p.sizes.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						className: `text-[11px] px-2.5 py-0.5 rounded-full border font-semibold transition-colors ${size === s ? "border-brand-orange text-brand-orange bg-cream" : "border-border text-muted-foreground hover:border-brand-orange"}`,
						children: s
					}, s))
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
