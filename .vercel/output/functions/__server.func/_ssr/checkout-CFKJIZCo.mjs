...
import { s as useCart } from "./collection-helpers-BfZPBpPQ.mjs";
...
import { H as Package, Lt as CreditCard, u as Truck, w as ShieldCheck } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/checkout-CFKJIZCo.js
...
function Checkout() {
	...
	(0, import_react.useEffect)(() => {
		...
		import("./analytics-By36XOiQ.mjs").then((n) => n.t).then((n) => n.t).then(({ track }) => track("begin_checkout", {
			currency: "INR",
			value: subtotal,
			items: items.map((i) => ({
				item_id: i.slug,
	...
	async function place() {
		...
		try {
			...
			if (method === "cod") {
				const { track } = await import("./analytics-By36XOiQ.mjs").then((n) => n.t).then((n) => n.t);
