...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-Ch3Fk0T3.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BPs5FInH.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DsAtERSj.mjs"),
		import("./start-4EJFXpIO.mjs"),
