...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-cms.functions-D_VEO5GC.js
...
//#endregion
export { adjustStock, deleteCategory, deleteCoupon, deleteHomepageVideo, deleteMedia, deletePost, getDashboardStats, inviteUser, listAudit, listCategories, listCoupons, listCustomers, listHomepageVideos, listMedia, listPosts, listSettings, listUsers, reorderHomepageVideos, seedDefaultCategoriesIfEmpty, sendPasswordReset, setUserRole, updateCustomer, updateOrderExtended, uploadCategoryImage, uploadMedia, uploadProductImage, upsertCategory, upsertCoupon, upsertHomepageVideo, upsertPost, upsertSetting };
