...
import { It as Download, P as Plus, R as Pencil, Rt as Copy, j as RefreshCcw, l as Upload, mt as ImageOff, p as Trash2, un as ArrowLeft, v as Star } from "../_libs/lucide-react.mjs";
import { listCategories, uploadProductImage, upsertCategory } from "./admin-cms.functions-D_VEO5GC.mjs";
...
import { i as listAdminProducts, l as saveProductVariants, s as listProductVariants, t as deleteProduct, u as upsertProduct } from "./admin-catalog.functions-CgqqVjgd.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin.products-asSNk3z-.js
...
function ProductsPage() {
	...
	if (edit) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProductForm, {
		initial: edit,
	...
	const filtered = q ? rows.filter((r) => [
		...
		r.sku,
		r.category
	].join(" ").toLowerCase().includes(q.toLowerCase())) : rows;
	const cols = [
		"slug",
		"name",
		"sku",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
			className: "p-3 mb-4 flex flex-wrap gap-2 items-center",
			children: [
...
function ProductForm({ initial, onCancel, onSave }) {
	...
	(0, import_react.useEffect)(() => {
		listCats({}).then((r) => {
			if (r.rows) setCats(r.rows.map((x) => ({
				name: x.name,
				slug: x.slug
			})));
		});
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: f.id ? "Edit product" : "New product"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									...
									className: "text-xs text-muted-foreground",
									children: "Upload up to 9 images. Recommended size: 1080 × 1080 px."
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Upload, { className: "size-3.5" }), uploadingMedia ? "UPLOADING…" : "UPLOAD GALLERY IMAGE"]
								})] })]
							}),
							(f.images ?? []).length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3",
								children: (f.images ?? []).map((u, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: `relative group rounded-2xl border p-2 bg-white flex flex-col justify-between ${i === 0 ? "border-2 border-burnt-orange shadow-md" : "border-border/80"}`,
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "relative aspect-square rounded-xl overflow-hidden bg-cream-deep/30 mb-2",
										children: [
											...
											i === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "absolute top-2 left-2 bg-burnt-orange text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow",
										...
										children: [i !== 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											...
											className: "text-xs font-bold text-burnt-orange",
											children: "Main storefront image"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [i > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												...
												title: "Move left/up",
												children: "←"
											}), i < (f.images ?? []).length - 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												type: "button",
												onClick: () => {
													const cur = [...f.images ?? []];
													const tmp = cur[i + 1];
								...
								className: "py-8 px-4 rounded-xl border-2 border-dashed border-border/80 text-center text-muted-foreground",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm",
									children: "No gallery images uploaded yet."
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs mt-1",
									children: "First image will automatically be selected as the Primary product image."
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
								label: "Or paste Gallery URLs (one per line)",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
									rows: 4,
									value: (f.images ?? []).join("\n"),
									onChange: (e) => {
