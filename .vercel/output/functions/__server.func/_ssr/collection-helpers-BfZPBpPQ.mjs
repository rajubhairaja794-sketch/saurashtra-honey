...
import { i as prod_honeycomb_default, n as honeycomb_bees_default, r as prod_giftpack_default, t as hero_honey_default } from "./prod-lychee-Di3dQ6EL.mjs";
import { d as prod_liquid_default, h as team_beekeepers_default, i as honey_drizzle_default, n as bee_flower_default, r as family_honey_default, t as bee_farm_default } from "./team-beekeepers-Bb0crWjH.mjs";
import { i as getVariantByLabel } from "./products-BzIDWMnY.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/collection-helpers-BfZPBpPQ.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var Ctx$1 = (0, import_react.createContext)(null);
var KEY$1 = "sh_cart_v1";
...
async function fetchCompanySettings() {
	...
	if (!inflight) inflight = Promise.resolve(supabase.from("site_settings").select("value").eq("key", "company").maybeSingle()).then(({ data, error }) => {
...
function useCompanySettings() {
	const [settings, setSettings] = (0, import_react.useState)(cache ?? void 0);
	(0, import_react.useEffect)(() => {
		let cancelled = false;
		fetchCompanySettings().then((c) => {
...
function getCategoryMetadata(slug, dbCategories) {
	...
	if (found) {
		...
		if (dbCat && dbCat.hasCustomImage && dbCat.image) return {
			...found,
	...
	const heroImg = dbCat?.image || "/assets/hero-honey-_5XoWxQ5.jpg";
	return {
		slug: normalized,
		name: displayName,
...
//#endregion
export { getCategoryProducts as a, useCompanyLogoUrl as c, getCategoryMetadata as i, useCompanySettings as l, DEDICATED_COLLECTION_SLUGS as n, getCategorySlug as o, WishlistProvider as r, useCart as s, CartProvider as t, useWishlist as u };
