...
import { i as getVariantByLabel, n as getProductGallery, t as getProductAdditionalImages } from "./products-BzIDWMnY.mjs";
...
import { o as getCategorySlug, s as useCart, u as useWishlist } from "./collection-helpers-BfZPBpPQ.mjs";
import { _ as useNavigate, g as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as fetchProducts } from "./product-catalog-nTITKWF8.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { A as RefreshCw, Et as Flower2, Jt as ChevronLeft, Kt as ChevronUp, P as Plus, S as ShoppingCart, T as Share2, U as PackageCheck, Xt as Check, Yt as ChevronDown, an as Beaker, b as Sparkles, et as LoaderCircle, gt as Heart, it as Leaf, n as ZoomIn, p as Trash2, pt as ImagePlus, q as MessageCircle, qt as ChevronRight, u as Truck, v as Star, w as ShieldCheck, wt as GitCompare } from "../_libs/lucide-react.mjs";
...
import { t as Route } from "./product._slug-DsJUnMeP.mjs";
import { t as ShoppableVideoCarousel } from "./ShoppableVideoCarousel-BOpztcuw.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/product._slug-9sdEtCMC.js
...
function ProductPage() {
	...
	(0, import_react.useEffect)(() => {
		pushRecent(p.slug);
		import("./analytics-By36XOiQ.mjs").then((n) => n.t).then((n) => n.t).then(({ track, toItem }) => {
			track("view_item", {
				currency: "INR",
				value: p.price,
				items: [toItem(p, { size })]
	...
	const handleAdd = () => {
		...
		import("./analytics-By36XOiQ.mjs").then((n) => n.t).then((n) => n.t).then(({ track, toItem }) => track("add_to_cart", {
			currency: "INR",
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-5 flex items-baseline gap-2.5 flex-wrap",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-espresso",
...
function MobileProductGallery({ images, name }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "md:hidden w-full -mx-4 px-4 sm:mx-0 sm:px-0 mb-4 relative",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: images.map((src, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							...
							alt: `${name} view ${idx + 1}`,
							loading: "lazy",
							className: "w-full h-full object-contain bg-white object-center pointer-events-none"
						})
					}, idx))
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
			...
			images.length > 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex gap-2.5 overflow-x-auto py-3 px-1 no-scrollbar mt-1",
