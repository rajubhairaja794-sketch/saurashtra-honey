...
//#region node_modules/.nitro/vite/services/ssr/assets/ShoppableVideoCarousel-BOpztcuw.js
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: "size-12 rounded-full border border-border/80 bg-white hover:bg-cream-deep hover:border-burnt-orange text-espresso flex items-center justify-center transition-all shadow-sm hover:scale-105",
